(() => {
  ...
  Object.assign(dictionaries["zh-TW"], {
    colorTheme: "界面配色", colorThemeDesc: "選擇擴充功能的強調色", themePink: "粉紅色", themeGreen: "綠色", themePurple: "紫色", themeBlue: "藍色", themeYellow: "黃色", alwaysTranslateSites: "一律翻譯的網站", alwaysTranslateSitesDesc: "開啟這些網站時會自動翻譯，清單只儲存在本機", noAlwaysTranslateSites: "尚無一律翻譯的網站", siteCount: "{count} 個網站", remove: "刪除", removeSite: "從一律翻譯的網站中刪除 {site}", siteRemoved: "已刪除 {site}，之後將不再自動翻譯"
  });
